import requests
from Notion_manage import NOTION_API_KEY, NOTION_DB_ID_TOTAL_CALC, NOTION_DB_ID_TASK, NOTION_DB_ID_CLIENT, headers

# Notionエンドポイント
url = f'https://api.notion.com/v1/databases/{NOTION_DB_ID_TASK}'
